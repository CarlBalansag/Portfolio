...
const TerminalTextAnimation = () => {
  const content = {
    ...
    experience: [
      ...
      { title: "Information Technology Student Support", company: "American River College", date: "Jan 2023 – Feb 2024", bullets: ["Provided technical support for students, faculty, and staff across hardware, software, network connectivity, classroom technology, and printer issues", "Deployed and configured campus workstations, including imaging laptops/desktops, setting up new workstations, cabling peripherals, and supporting 200 networked printers"] },
